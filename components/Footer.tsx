...
export default function Footer() {
    return <div className="dark:text-white">
        ...
        <section className="md:px-8 px-4 py-8 mt-4 mb-6">
            <div className="rounded-xl py-4 bg-black w-full h-96 flex gap-5 justify-center items-center flex-col dark:bg-zinc-900 text-white">
            ...
            <p className="text-center md:px-0 px-4 dark:text-zinc-400 font-semibold md:text-base text-xs">Use this text to share information about your brand with your customers. <br /> Describe a product, share announcements, or welcome customers to your store.</p>
            </div>
        </section>
