...
const HamburgerMenu = () => {
    ...
    return (
      <button className="md:hidden" onClick={toggleMenu}>
        {isOpen ? (
          <div>
            <div className='absolute top-1 left-0 right-0 border border-gray-500 w-full bg-white  dark:bg-zinc-700 dark:text-white'>
                <div className='flex px-6 py-5 items-center justify-between border-b-2'>
                    <h3 className='text-2xl font-sans'>Menu</h3>
                    <IoClose size={32} />
                </div>
                <div className='flex items-center justify-between w-full px-3 border-b-2'>
                    {/* LEFT */}
                    <div className='flex py-5 gap-3 items-center'>
                        <div>
                            <Image src={'/shop.png'} alt={'Home-icon'} height={30} width={30} className='dark:hidden flex'/>
                            <Image src={'/shop_dark.png'} alt={'Home-icon'} height={30} width={30} className='dark:flex hidden'/>
                        </div>
                        <div className='flex flex-col  justify-start'>
                            <div className='text-xs text-start'>Picking up?</div>
                            <div className='text-start text-sm font-medium flex gap-1'>Select store <FaChevronDown size={12}/></div>
                        </div>
                    </div>
                    {/* RIGHT */}
                    <div className='flex py-5 gap-3 items-center'>
                        <div>
                            ...
                            <Image src={'/box_dark.png'} alt={'Delivery-Box'} height={30} width={30} className='dark:flex hidden'/>
                        </div>
                        <div className='flex flex-col  justify-start'>
                ...
                <div className='w-full flex justify-start flex-col border-b-2'>
                    <Link href={"#"} className='text-start p-3 border-b-2 font-light flex w-full justify-between'>
                        <h1>Categories</h1><FaAngleRight size={24}/>
                    </Link>
                    <Link href={"#"} className='font-light text-start p-3 border-b-2'>
                        Our stores
                    </Link>
                    <Link href={"#"} className='font-light text-start p-3 border-b-2'>
                        Recipes
                    ...
                    <Link href={"#"} className='flex gap-3 items-center font-light text-start p-3'>
